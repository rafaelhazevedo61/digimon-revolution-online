...
-- Pesos internos normalizados conforme a regra-base da referência:
-- material/XP de entrada = 60, núcleo/incubadora/Digitama = 30,
-- baú de fragmentos/recompensa de progressão específica = 20 antes da normalização.
-- Assim, itens da mesma categoria ficam em 50/50; XP Disc + núcleo fica em 67/33.
