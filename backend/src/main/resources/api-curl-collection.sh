...
# curl --fail-with-body -i -X POST "${BASE_URL}/admin/bosses" -H "Authorization: Bearer ${ADMIN_TOKEN}" -H "Content-Type: application/json" -d '{"code": "example-code", "name": "example-name", "bossType": "example-bossType", "requiredStage": "example-requiredStage", "requiredLevel": 1, "requiredRebirths": 1, "hp": 1, "atk": 1, "def": 1, "energyCost": 1, "cooldownMinutes": 1, "baseXpReward": 1, "baseBitsReward": 1, "defeatXpPercent": 1, "imageUrl": "example-imageUrl", "chestCode": "example-chestCode", "worldAttemptChestCode": "example-worldAttemptChestCode", "worldTopDamageChestCode": "example-worldTopDamageChestCode", "worldFinalBlowChestCode": "example-worldFinalBlowChestCode"}'
...
# curl --fail-with-body -i -X PUT "${BASE_URL}/admin/bosses/${ID}" -H "Authorization: Bearer ${ADMIN_TOKEN}" -H "Content-Type: application/json" -d '{"name": "example-name", "bossType": "example-bossType", "requiredStage": "example-requiredStage", "requiredLevel": 1, "requiredRebirths": 1, "hp": 1, "atk": 1, "def": 1, "energyCost": 1, "cooldownMinutes": 1, "baseXpReward": 1, "baseBitsReward": 1, "defeatXpPercent": 1, "imageUrl": "example-imageUrl", "active": true, "chestCode": "example-chestCode", "equipmentChance": 1, "worldAttemptChestCode": "example-worldAttemptChestCode", "worldTopDamageChestCode": "example-worldTopDamageChestCode", "worldFinalBlowChestCode": "example-worldFinalBlowChestCode"}'
