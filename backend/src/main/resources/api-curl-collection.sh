...
# curl --fail-with-body -i -X POST "${BASE_URL}/admin/bosses/${BOSS_ID}/drops" -H "Authorization: Bearer ${ADMIN_TOKEN}"
...
# curl --fail-with-body -i -X POST "${BASE_URL}/admin/digimon/add-xp" -H "Authorization: Bearer ${ADMIN_TOKEN}"
...
# curl --fail-with-body -i -X POST "${BASE_URL}/admin/equipment-templates" -H "Authorization: Bearer ${ADMIN_TOKEN}"

# AdminEquipmentTemplateController.grant (POST /admin/equipment-templates/grant)
# curl --fail-with-body -i -X POST "${BASE_URL}/admin/equipment-templates/grant" -H "Authorization: Bearer ${ADMIN_TOKEN}"
...
# curl --fail-with-body -i -X PUT "${BASE_URL}/admin/equipment-templates/${NAME}" -H "Authorization: Bearer ${ADMIN_TOKEN}"
...
# curl --fail-with-body -i -X POST "${BASE_URL}/admin/inventory/grant" -H "Authorization: Bearer ${ADMIN_TOKEN}"
...
# curl --fail-with-body -i -X POST "${BASE_URL}/admin/missions" -H "Authorization: Bearer ${ADMIN_TOKEN}"
...
# curl --fail-with-body -i -X PUT "${BASE_URL}/admin/missions/${ID}" -H "Authorization: Bearer ${ADMIN_TOKEN}"
...
# curl --fail-with-body -i -X POST "${BASE_URL}/admin/players/wipe" -H "Authorization: Bearer ${ADMIN_TOKEN}"

# AdminPlayerController.resetPassword (POST /admin/players/{id}/reset-password)
# curl --fail-with-body -i -X POST "${BASE_URL}/admin/players/${ID}/reset-password" -H "Authorization: Bearer ${ADMIN_TOKEN}"
...
# curl --fail-with-body -i -X POST "${BASE_URL}/admin/server/damage-buff" -H "Authorization: Bearer ${ADMIN_TOKEN}"
...
# curl --fail-with-body -i -X POST "${BASE_URL}/admin/shop-products" -H "Authorization: Bearer ${ADMIN_TOKEN}"
...
# curl --fail-with-body -i -X PUT "${BASE_URL}/admin/shop-products/${CODE}" -H "Authorization: Bearer ${ADMIN_TOKEN}"
...
# curl --fail-with-body -i -X GET "${BASE_URL}/areas"

# ===== ARENA =====

# ArenaController.challenge (POST /arena/challenge)
# curl --fail-with-body -i -X POST "${BASE_URL}/arena/challenge"

# ArenaController.getHistory (GET /arena/history)
# curl --fail-with-body -i -X GET "${BASE_URL}/arena/history"

# ArenaController.getLobby (GET /arena/lobby)
# curl --fail-with-body -i -X GET "${BASE_URL}/arena/lobby"

# ArenaController.getRanking (GET /arena/ranking)
# curl --fail-with-body -i -X GET "${BASE_URL}/arena/ranking"

# ArenaController.getShop (GET /arena/shop)
# curl --fail-with-body -i -X GET "${BASE_URL}/arena/shop"

# ArenaController.buyFromShop (POST /arena/shop/buy)
# curl --fail-with-body -i -X POST "${BASE_URL}/arena/shop/buy"

# ===== AUCTION =====

# AuctionController.history (GET /auction/history)
# curl --fail-with-body -i -X GET "${BASE_URL}/auction/history"

# AuctionController.list (GET /auction/listings)
# curl --fail-with-body -i -X GET "${BASE_URL}/auction/listings"

# AuctionController.create (POST /auction/listings)
# curl --fail-with-body -i -X POST "${BASE_URL}/auction/listings"

# AuctionController.buy (POST /auction/listings/{listingId}/buy)
# curl --fail-with-body -i -X POST "${BASE_URL}/auction/listings/${LISTING_ID}/buy"

# AuctionController.cancel (POST /auction/listings/{listingId}/cancel)
# curl --fail-with-body -i -X POST "${BASE_URL}/auction/listings/${LISTING_ID}/cancel"

# AuctionController.myListings (GET /auction/my-listings)
# curl --fail-with-body -i -X GET "${BASE_URL}/auction/my-listings"
...
# curl --fail-with-body -i -X GET "${BASE_URL}/bosses/available"

# BossController.getCooldowns (GET /bosses/cooldowns)
# curl --fail-with-body -i -X GET "${BASE_URL}/bosses/cooldowns"

# BossController.getHistory (GET /bosses/history)
# curl --fail-with-body -i -X GET "${BASE_URL}/bosses/history"

# BossController.challenge (POST /bosses/{bossCode}/challenge)
# curl --fail-with-body -i -X POST "${BASE_URL}/bosses/${BOSS_CODE}/challenge"

# ===== ROOT =====

# ClanMissionController.list (GET /clan-missions)
# curl --fail-with-body -i -X GET "${BASE_URL}/clan-missions"

# ===== CLAN-MISSIONS =====

# ClanMissionController.getMyMission (GET /clan-missions/me)
# curl --fail-with-body -i -X GET "${BASE_URL}/clan-missions/me"

# ClanMissionController.getRanking (GET /clan-missions/ranking)
# curl --fail-with-body -i -X GET "${BASE_URL}/clan-missions/ranking"

# ClanMissionController.accept (POST /clan-missions/{id}/accept)
# curl --fail-with-body -i -X POST "${BASE_URL}/clan-missions/${ID}/accept"

# ClanMissionController.claim (POST /clan-missions/{id}/claim)
# curl --fail-with-body -i -X POST "${BASE_URL}/clan-missions/${ID}/claim"

# ===== CLAN-RAIDS =====

# ClanRaidController.attack (POST /clan-raids/attack)
# curl --fail-with-body -i -X POST "${BASE_URL}/clan-raids/attack"

# ClanRaidController.getMyClanRaid (GET /clan-raids/me)
# curl --fail-with-body -i -X GET "${BASE_URL}/clan-raids/me"

# ===== ROOT =====

# ClanController.list (GET /clans)
# curl --fail-with-body -i -X GET "${BASE_URL}/clans"

# ClanController.create (POST /clans)
# curl --fail-with-body -i -X POST "${BASE_URL}/clans"

# ===== CLANS =====

# ClanController.getMyClan (GET /clans/me)
# curl --fail-with-body -i -X GET "${BASE_URL}/clans/me"

# ClanController.getRanking (GET /clans/ranking)
# curl --fail-with-body -i -X GET "${BASE_URL}/clans/ranking"

# ClanController.dissolve (DELETE /clans/{id})
# curl --fail-with-body -i -X DELETE "${BASE_URL}/clans/${ID}"

# ClanController.getById (GET /clans/{id})
# curl --fail-with-body -i -X GET "${BASE_URL}/clans/${ID}"

# ClanController.update (PATCH /clans/{id})
# curl --fail-with-body -i -X PATCH "${BASE_URL}/clans/${ID}"

# ClanController.invite (POST /clans/{id}/invite)
# curl --fail-with-body -i -X POST "${BASE_URL}/clans/${ID}/invite"

# ClanController.join (POST /clans/{id}/join)
# curl --fail-with-body -i -X POST "${BASE_URL}/clans/${ID}/join"

# ClanController.leave (POST /clans/{id}/leave)
# curl --fail-with-body -i -X POST "${BASE_URL}/clans/${ID}/leave"

# ClanController.kick (POST /clans/{id}/members/{username}/kick)
# curl --fail-with-body -i -X POST "${BASE_URL}/clans/${ID}/members/${USERNAME}/kick"

# ClanController.changeRole (POST /clans/{id}/members/{username}/role)
# curl --fail-with-body -i -X POST "${BASE_URL}/clans/${ID}/members/${USERNAME}/role"

# ClanController.transferLeadership (POST /clans/{id}/members/{username}/transfer)
# curl --fail-with-body -i -X POST "${BASE_URL}/clans/${ID}/members/${USERNAME}/transfer"

# ClanController.listUpgrades (GET /clans/{id}/upgrades)
# curl --fail-with-body -i -X GET "${BASE_URL}/clans/${ID}/upgrades"

# ClanController.buyUpgrade (POST /clans/{id}/upgrades/{code}/buy)
# curl --fail-with-body -i -X POST "${BASE_URL}/clans/${ID}/upgrades/${CODE}/buy"

# ===== ROOT =====

# DigimonInfoController.getDigimonInfos (GET /digimon-infos)
# curl --fail-with-body -i -X GET "${BASE_URL}/digimon-infos"
...
# curl --fail-with-body -i -X GET "${BASE_URL}/digimon/me"
...
# curl --fail-with-body -i -X POST "${BASE_URL}/digimon/select"

# DigimonController.simulateTraitHatch (GET /digimon/simulator/trait-hatch)
# curl --fail-with-body -i -X GET "${BASE_URL}/digimon/simulator/trait-hatch"

# DigimonController.storage (GET /digimon/storage)
# curl --fail-with-body -i -X GET "${BASE_URL}/digimon/storage"

# DigimonController.getById (GET /digimon/{digimonId})
# curl --fail-with-body -i -X GET "${BASE_URL}/digimon/${DIGIMON_ID}"

# DigimonController.evolutionOptions (GET /digimon/{digimonId}/evolution-options)
# curl --fail-with-body -i -X GET "${BASE_URL}/digimon/${DIGIMON_ID}/evolution-options"

# DigimonController.lineage (GET /digimon/{digimonId}/lineage)
# curl --fail-with-body -i -X GET "${BASE_URL}/digimon/${DIGIMON_ID}/lineage"

# DigimonController.rebirthPreview (GET /digimon/{digimonId}/rebirth-preview)
# curl --fail-with-body -i -X GET "${BASE_URL}/digimon/${DIGIMON_ID}/rebirth-preview"

# DigimonController.retrieve (POST /digimon/{digimonId}/retrieve)
# curl --fail-with-body -i -X POST "${BASE_URL}/digimon/${DIGIMON_ID}/retrieve"

# DigimonController.store (POST /digimon/{digimonId}/store)
# curl --fail-with-body -i -X POST "${BASE_URL}/digimon/${DIGIMON_ID}/store"
...
# curl --fail-with-body -i -X GET "${BASE_URL}/digitama/hatch"

# DigitamaController.history (GET /digitama/history)
# curl --fail-with-body -i -X GET "${BASE_URL}/digitama/history"

# DigitamaController.select (POST /digitama/select)
# curl --fail-with-body -i -X POST "${BASE_URL}/digitama/select"

# ===== EQUIPMENT =====

# EquipmentController.getDigimonEquipment (GET /equipment/digimon/{digimonId})
# curl --fail-with-body -i -X GET "${BASE_URL}/equipment/digimon/${DIGIMON_ID}"

# EquipmentController.getDigimonInventory (GET /equipment/digimon/{digimonId}/inventory)
# curl --fail-with-body -i -X GET "${BASE_URL}/equipment/digimon/${DIGIMON_ID}/inventory"
...
# curl --fail-with-body -i -X POST "${BASE_URL}/equipment/refine"
...
# curl --fail-with-body -i -X GET "${BASE_URL}/equipment/${EQUIPMENT_ID}/refine-preview"

# ===== ROOT =====

# EvolutionLineController.getEvolutionLines (GET /evolution-lines)
# curl --fail-with-body -i -X GET "${BASE_URL}/evolution-lines"
...
# curl --fail-with-body -i -X POST "${BASE_URL}/incubation/claim"

# IncubationController.me (GET /incubation/me)
# curl --fail-with-body -i -X GET "${BASE_URL}/incubation/me"

# IncubationController.start (POST /incubation/start)
# curl --fail-with-body -i -X POST "${BASE_URL}/incubation/start"

# ===== ROOT =====

# InventoryController.getInventory (GET /inventory)
# curl --fail-with-body -i -X GET "${BASE_URL}/inventory"

# ===== INVENTORY =====

# InventoryController.useItem (POST /inventory/use)
# curl --fail-with-body -i -X POST "${BASE_URL}/inventory/use"

# ===== ROOT =====

# ItemDefinitionController.getItems (GET /items)
# curl --fail-with-body -i -X GET "${BASE_URL}/items"

# MailController.send (POST /mail)
# curl --fail-with-body -i -X POST "${BASE_URL}/mail"

# ===== MAIL =====

# MailController.inbox (GET /mail/inbox)
# curl --fail-with-body -i -X GET "${BASE_URL}/mail/inbox"

# MailController.sent (GET /mail/sent)
# curl --fail-with-body -i -X GET "${BASE_URL}/mail/sent"
...
# curl --fail-with-body -i -X DELETE "${BASE_URL}/mail/${MESSAGE_ID}"

# MailController.get (GET /mail/{messageId})
# curl --fail-with-body -i -X GET "${BASE_URL}/mail/${MESSAGE_ID}"

# MailController.action (POST /mail/{messageId}/action)
# curl --fail-with-body -i -X POST "${BASE_URL}/mail/${MESSAGE_ID}/action"

# MailController.markRead (POST /mail/{messageId}/read)
# curl --fail-with-body -i -X POST "${BASE_URL}/mail/${MESSAGE_ID}/read"

# ===== ROOT =====

# MissionController.list (GET /missions)
# curl --fail-with-body -i -X GET "${BASE_URL}/missions"

# ===== MISSIONS =====

# MissionController.getActiveMissions (GET /missions/active)
# curl --fail-with-body -i -X GET "${BASE_URL}/missions/active"

# MissionController.start (POST /missions/start)
# curl --fail-with-body -i -X POST "${BASE_URL}/missions/start"

# MissionController.claimMission (POST /missions/{missionInstanceId}/claim)
# curl --fail-with-body -i -X POST "${BASE_URL}/missions/${MISSION_INSTANCE_ID}/claim"

# ===== PLAYERS =====

# PlayerController.me (GET /players/me)
# curl --fail-with-body -i -X GET "${BASE_URL}/players/me"

# PlayerController.changePassword (POST /players/me/change-password)
# curl --fail-with-body -i -X POST "${BASE_URL}/players/me/change-password"

# PlayerController.dashboard (GET /players/me/dashboard)
# curl --fail-with-body -i -X GET "${BASE_URL}/players/me/dashboard"

# PlayerController.startup (GET /players/me/startup)
# curl --fail-with-body -i -X GET "${BASE_URL}/players/me/startup"

# ===== RANKING =====

# RankingController.byGrade (GET /ranking/grade)
# curl --fail-with-body -i -X GET "${BASE_URL}/ranking/grade"

# RankingController.byLevel (GET /ranking/level)
# curl --fail-with-body -i -X GET "${BASE_URL}/ranking/level"

# RankingController.byRebirth (GET /ranking/rebirth)
# curl --fail-with-body -i -X GET "${BASE_URL}/ranking/rebirth"
...
# curl --fail-with-body -i -X POST "${BASE_URL}/shop/buy"

# ShopController.sell (POST /shop/sell)
# curl --fail-with-body -i -X POST "${BASE_URL}/shop/sell"
...
# curl --fail-with-body -i -X POST "${BASE_URL}/world-boss/attack"

# WorldBossController.getMyWorldBoss (GET /world-boss/me)
# curl --fail-with-body -i -X GET "${BASE_URL}/world-boss/me"
