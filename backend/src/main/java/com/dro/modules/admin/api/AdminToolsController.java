...
public class AdminToolsController {
    ...
    public ResponseEntity<Map<String, Object>> resetDailyArenaAttacks(
        ...
        audit(authorization, "ADMIN_RESET_DAILY_ARENA_ATTACKS", "reset-daily-arena-attacks",
                Map.of("playersReset", playersReset));
    ...
    public ResponseEntity<Map<String, Object>> resetClanRaidDaily(
        ...
        audit(authorization, "ADMIN_RESET_CLAN_RAID_DAILY", "reset-clan-raid-daily",
                Map.of("raidsReset", raidsReset));
        return ResponseEntity.ok(Map.of(
    ...
    public ResponseEntity<Map<String, Object>> resetWorldBossDaily(
        ...
        audit(authorization, "ADMIN_RESET_WORLD_BOSS_DAILY", "reset-world-boss-daily",
                Map.of("instancesReset", instancesReset));
        return ResponseEntity.ok(Map.of(
    ...
    public ResponseEntity<Map<String, Object>> forceNewWorldBossCycle(
        ...
        audit(authorization, "ADMIN_FORCE_NEW_WORLD_BOSS_CYCLE", "force-new-world-boss-cycle",
                Map.of("instanceId", instance.getId(), "cycleNumber", instance.getCycleNumber()));
        return ResponseEntity.ok(Map.of(
    ...
    public ResponseEntity<Map<String, Object>> completeClanMissions(
        ...
        audit(authorization, "ADMIN_COMPLETE_CLAN_MISSIONS", "complete-clan-missions",
                Map.of("completedCount", completed));
        return ResponseEntity.ok(Map.of(
    ...
    private void audit(
        ...
        adminAuditService.success(
                ...
                operation,
                operation,
                "Ferramenta administrativa executada",
                metadata
        );
    }
}
