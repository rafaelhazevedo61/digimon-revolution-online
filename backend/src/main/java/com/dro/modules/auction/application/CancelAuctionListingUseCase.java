...
public class CancelAuctionListingUseCase {
    ...
    public AuctionListingResponse execute(String token, UUID listingId) {
        ...
        AuctionListing listing = auctionListingRepository.findByIdForUpdate(listingId).orElseThrow(() -> new NotFoundException("Auction listing not found"));
    ...
    private Digimon findLockedSellerDigimon(Player player, AuctionListing listing) {
        if (listing.getSellerDigimonId() != null) {
            Digimon sellerDigimon = digimonRepository.findByIdForUpdate(listing.getSellerDigimonId()).orElseThrow(() -> new NotFoundException("Source Digimon not found"));
    ...
    private void saveInventory(InventoryItem item, Digimon digimon, ItemDefinition definition, int quantity) {
        if (item != null) {
