...
public class BossController {
    ...
    public ResponseEntity<List<BossDefinitionResponse>> getAvailable(
    ...
    public ResponseEntity<BossChallengeResponse> challenge(
            @RequestHeader("Authorization") String authorization,
            @PathVariable String bossCode,
            @RequestBody @Valid ChallengeBossRequest request
    ) {
        return ResponseEntity.ok(challengeBossUseCase.execute(authorization, bossCode, request.digimonId()));
    }

    @GetMapping("/history")
    public ResponseEntity<List<BossAttemptResponse>> getHistory(
            @RequestHeader("Authorization") String authorization,
    ...
    public ResponseEntity<List<BossCooldownResponse>> getCooldowns(
            @RequestHeader("Authorization") String authorization
    ) {
