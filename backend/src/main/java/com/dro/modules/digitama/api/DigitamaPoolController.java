...
public class DigitamaPoolController {
    ...
    public DigitamaPoolController(final GetAvailableDigitamaPoolsUseCase getAvailableDigitamaPoolsUseCase) {
        this.getAvailableDigitamaPoolsUseCase = getAvailableDigitamaPoolsUseCase;
    }
}
