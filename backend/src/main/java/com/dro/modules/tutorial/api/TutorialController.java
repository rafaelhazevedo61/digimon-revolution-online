...
public class TutorialController {
    ...
    @GetMapping
    public ResponseEntity<TutorialProgressResponse> getProgress(@RequestHeader("Authorization") String authorization) {
        return ResponseEntity.ok(tutorialService.getProgress(authorization));
    }

    @PostMapping("/steps/{step}/claim")
    public ResponseEntity<TutorialProgressResponse> claimReward(@RequestHeader("Authorization") String authorization, @PathVariable String step) {
        return ResponseEntity.ok(tutorialService.claimReward(authorization, step));
    }

    @PostMapping("/finish")
    public ResponseEntity<TutorialProgressResponse> finishTutorial(@RequestHeader("Authorization") String authorization) {
