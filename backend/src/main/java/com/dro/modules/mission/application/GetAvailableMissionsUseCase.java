...
public class GetAvailableMissionsUseCase {
    ...
    public List<MissionResponse> execute(String token) {
        ...
        return missionDefinitionRepository.findByActiveTrue().stream()
                .filter(mission -> isAvailableFor(activeDigimon, mission))
                .sorted(Comparator
    ...
    private boolean isAvailableFor(Digimon digimon, MissionDefinitionEntity mission) {
        ...
        return digimon.getLevel() >= mission.getRequiredLevel();
    }
    ...
    public GetAvailableMissionsUseCase(
            final PlayerRepository playerRepository,
            final DigimonRepository digimonRepository,
            final MissionDefinitionRepository missionDefinitionRepository
    ) {
