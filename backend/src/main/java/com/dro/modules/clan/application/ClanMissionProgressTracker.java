...
public class ClanMissionProgressTracker {
    ...
    public void track(UUID playerId, ClanMissionObjectiveType objectiveType) {
        PlayerClanMission active = playerClanMissionRepository.findByPlayerIdAndStatus(playerId, PlayerClanMissionStatus.IN_PROGRESS).orElse(null);
        if (active == null) {
            return;
        }
        ClanMission mission = clanMissionRepository.findById(active.getClanMissionId()).orElse(null);
    ...
    public ClanMissionProgressTracker(final PlayerClanMissionRepository playerClanMissionRepository, final ClanMissionRepository clanMissionRepository) {
