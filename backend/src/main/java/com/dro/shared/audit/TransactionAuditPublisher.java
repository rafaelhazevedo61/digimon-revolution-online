...
public class TransactionAuditPublisher {
     ...
     */
    public void success(String eventId, String eventType, String aggregateType, String aggregateId, Map<String, Object> payload) {
        outboxService.enqueue(eventId, eventType, aggregateType, aggregateId, CorrelationIdContext.current(), payload);
    }

    public TransactionAuditPublisher(final AuditOutboxService outboxService) {
