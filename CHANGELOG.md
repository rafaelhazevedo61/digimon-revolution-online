...
- **Tela de Missões**: áreas agora aparecem da maior progressão para a menor e, dentro de cada área, as missões são ordenadas pelo maior requisito de nível para o menor, usando o número da missão como desempate; cada missão também permite consultar suas recompensas possíveis em um modal, incluindo itens fixos, loot aleatório e conteúdo de baús.
